import cv2 as cv
import numpy as np
from helpers.Processing import processImage, rectContour, getCornerPoints, reoOrderContourPoints, extractedChosenAnswers
import helpers.File as FileHelper


class OMR:
    def __init__(self, file, questions_count, choices_count, correct_answers, paper_dimension):
        self.image = file
    ...
    def correctPrespective(self):
        ...
        # draw the container
        cv.drawContours(self.modified_image, [
                        orderedPoints], -1, (0, 255, 0), 5)
    ...
    def extractChoices(self):
        ...
        response = extractedChosenAnswers(
            threshold, self.questions, self.choices)
    ...
    def score(self):
        ...
        return str((score / self.questions) * 100) + '%'
